...
public class FeatureTypeRegistry {
    public static final DeferredRegister<FoliagePlacerType<?>> FOLIAGE_PLACER_TYPES = DeferredRegister.create(SleepyHollows.MOD_ID, Registries.FOLIAGE_PLACER_TYPE);
    public static final DeferredRegister<TreeDecoratorType<?>> TREE_DECORATOR_TYPES = DeferredRegister.create(SleepyHollows.MOD_ID, Registries.TREE_DECORATOR_TYPE);
