...
public class ObjectRegistry {
    ...
    public static final RegistrySupplier<Item> HAUNTBOUND_HELMET = registerItem("hauntbound_helmet", () -> new HauntboundHelmetItem(ArmorMaterialRegistry.HAUNTBOUND_ARMOR, ArmorItem.Type.HELMET, getSettings().rarity(Rarity.EPIC), SleepyHollows.identifier("textures/models/armor/hauntbound_helmet.png")));
    public static final RegistrySupplier<Item> HAUNTBOUND_CHESTPLATE = registerItem("hauntbound_chestplate", () -> new HauntboundChestplateItem(ArmorMaterialRegistry.HAUNTBOUND_ARMOR, ArmorItem.Type.CHESTPLATE, getSettings().rarity(Rarity.EPIC), SleepyHollows.identifier("textures/models/armor/hauntbound_armor_outer_layer.png")));
    public static final RegistrySupplier<Item> HAUNTBOUND_LEGGINGS = registerItem("hauntbound_leggings", () -> new HauntboundLeggingsItem(ArmorMaterialRegistry.HAUNTBOUND_ARMOR, ArmorItem.Type.LEGGINGS, getSettings().rarity(Rarity.EPIC), SleepyHollows.identifier("textures/models/armor/hauntbound_armor_inner_layer.png")));
    public static final RegistrySupplier<Item> HAUNTBOUND_BOOTS = registerItem("hauntbound_boots", () -> new HauntboundBootsItem(ArmorMaterialRegistry.HAUNTBOUND_ARMOR, ArmorItem.Type.BOOTS, getSettings().rarity(Rarity.EPIC), SleepyHollows.identifier("textures/models/armor/hauntbound_armor_outer_layer.png")));
    ...
    public static final RegistrySupplier<Item> DUSK_BERRIES = registerItem("dusk_berries", () -> new DuskBerryItem(DUSKBERRY_BUSH.get(), getSettings().food(Foods.SWEET_BERRIES)));
    ...
    public static final RegistrySupplier<Item> CANDY_CORN = registerItem("candy_corn", () -> new CandyCornItem(getSettings().food(Foods.SWEET_BERRIES)));
