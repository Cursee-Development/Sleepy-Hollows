...
public class HauntboundChestplateRenderer implements ArmorRenderer {
    ...
    public void render(PoseStack matrices, MultiBufferSource vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, HumanoidModel<LivingEntity> contextModel) {
        ...
        if (!(stack.getItem() instanceof HauntboundChestplateItem hauntboundChestplateItem)) return;
        Model model = ArmorRegistry.getChestplateModel(hauntboundChestplateItem, contextModel.body, contextModel.leftArm, contextModel.rightArm);
        ResourceLocation base = hauntboundChestplateItem.getChestplateTexture();
